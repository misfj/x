...
func newUserInfo(db *gorm.DB, opts ...gen.DOOption) userInfo {
	...
	_userInfo.CreateAt = field.NewTime(tableName, "create_at")
	_userInfo.UpdateAt = field.NewTime(tableName, "update_at")
	_userInfo.DeleteAt = field.NewTime(tableName, "delete_at")
	_userInfo.UserName = field.NewString(tableName, "user_name")
	_userInfo.NickName = field.NewString(tableName, "nick_name")
	_userInfo.UserLevel = field.NewString(tableName, "user_level")
	_userInfo.UserPhone = field.NewString(tableName, "user_phone")
	_userInfo.UserSourceType = field.NewString(tableName, "user_source_type")
	_userInfo.UserSource = field.NewString(tableName, "user_source")
	_userInfo.UserType = field.NewString(tableName, "user_type")
	_userInfo.Did = field.NewString(tableName, "did")
...
type userInfo struct {
	...
	UserLevel      field.String // 用户级别
	UserPhone      field.String // 用户手机号
	UserSourceType field.String // 1表示超级节点 2表示平台注册 3业务应用
	UserSource     field.String // 存储用户来源的详细信息
	UserType       field.String // 1表示个人 2表示企业 3表示政府部门
	Did            field.String // 用户did
...
func (u *userInfo) updateTableName(table string) *userInfo {
	...
	u.UserSourceType = field.NewString(table, "user_source_type")
	u.UserSource = field.NewString(table, "user_source")
	u.UserType = field.NewString(table, "user_type")
	u.Did = field.NewString(table, "did")
...
func (u *userInfo) fillFieldMap() {
	...
	u.fieldMap["user_source_type"] = u.UserSourceType
	u.fieldMap["user_source"] = u.UserSource
	u.fieldMap["user_type"] = u.UserType
	u.fieldMap["did"] = u.Did
}

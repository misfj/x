...
func newSysMenu(db *gorm.DB, opts ...gen.DOOption) sysMenu {
	...
	_sysMenu.CreateAt = field.NewTime(tableName, "create_at")
	_sysMenu.UpdateAt = field.NewTime(tableName, "update_at")
	_sysMenu.DeleteAt = field.NewTime(tableName, "delete_at")
	_sysMenu.MenuLevel = field.NewInt32(tableName, "menu_level")
	...
	_sysMenu.Compoment = field.NewString(tableName, "compoment")
...
func (s *sysMenu) updateTableName(table string) *sysMenu {
	...
	s.Compoment = field.NewString(table, "compoment")
...
func (s *sysMenu) fillFieldMap() {
	...
	s.fieldMap["compoment"] = s.Compoment
